...
if (language = "en") 
{
    ...
    global string_disclaimer := "If you've downloaded the loader from third-party sources, we decline all responsibility in case of infection of your system.`nMake sure that you downloaded the loader from trusted sources, such as: `nGitLab, official website fetloader.xyz or Telegram channel @ayeloader."
...
if (language = "ru") 
{
    ...
    global string_disclaimer := "Если вы загрузили лоадер из непроверенных источников, мы полностью снимаем с себя ответственность в случае заражения вашей системы.`nУбедитесь, что загрузили лоадер с проверенных источников, таких как: `nGitLab, официальный сайт fetloader.xyz, Telegram-канал @ayeloader."
